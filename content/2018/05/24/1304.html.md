...
date: 2018-05-24T17:36:33+09:00
lastmod: 2018-05-24T19:27:28+09:00
---

GCP のメルマガの雑な翻訳です。日本語は信用しないでください。
...
ワークフローを管理したいときに自前で Digdag 立てるか Airflow 立てるか…となってましたが、マネージドでオープンソースなワークフローエンジンが提供されるのはとても便利ですね。
...
今までまるで使えなかったので標準の Stackdriver で使い物になるのはありがたいですね。
...
結構待ち望まれてると思われるやつですね。フルマネージド Kubernetes だけでインフラ管理がすべて完結するみたいな世界きてほしいですねー。
