...
date: 2018-08-21T13:00:04+09:00
lastmod: 2018-08-21T13:00:04+09:00
---
...
Knative もう GA なんですね。GKE にアドオンとして入れるには Early Access のリクエストが必要みたいです。
...
今は線形回帰と 2 値ロジスティック回帰だけみたいですが、いろいろできること増えそう。
...
最近力いれてる感ありますね。CircleCI がめんどくさいので乗り換えようか検討中です。
...
名前がいいですよね。メガメム。Memory-optimized なマシンタイプでもうひとつ ultramem ってのがあるけど命名が気になる。。。
...
ブート前にチェックしてくれるのは気が利いてますね。VM 作成時に Shielded にできるみたいです。
...
Datastore とかはどうなってんだろ :thinking: 
...
Google Cloud における Apigee の立ち位置がよくわかってない。
...
GCP 内でフルマネージドで完結するってのはありがたいですよね。
...
Translation もあったんですね。単純な対訳コーパスを食わせればいいみたい。
...
Go 版の fog 的なやつ？Google から出てるってのが面白いですね。
