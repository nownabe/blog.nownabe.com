...
date: 2018-01-29T17:56:06+09:00
lastmod: 2018-01-31T17:38:58+09:00
---
...
`np.newaxis` とはなんぞ。ということで調べてみた。`np.newaxis` 自体はただの `None`。numpy の slice に自動で shape をよろしくやってくれる機能があって、`None` のかわりに `np.newaxis` って書くとかっこいいぜってことらしい。
...
ここでの LDA は Linear Discriminant Analysis で、Latent Dirichlet Allocation とは別物

全然関係ないけどなんで notes にも同じこと書いてあるんだ…？誤植？
...
ディリクレさんの LDA が実装されたのと同じタイミングで名前変わったっぽいから混同しないようにかな。
