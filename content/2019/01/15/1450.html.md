...
date: 2019-01-15T13:38:23+09:00
lastmod: 2019-01-15T13:38:23+09:00
---
...
GKE にマネージドの Istio をデプロイできるようになったってやつです。いいですね！！　:tada:
既存のクラスタにも追加できて、Addon に Istio があるのでそれを Enable にするだけです。
...
各 Node に割り当てる CIDR ブロックを変更できる機能です。デフォルトでは `/24` を割り当て、Pod 数は上限 110 ですがこれを `/28` まで減らせる感じです。
...
filesystem やネイティブコードが動くのは gVisor の恩恵ですね。
...
いろいろカスタマイズできる Authentication as a Service らしいです。
