...
date: 2017-12-25T16:41:47+09:00
lastmod: 2017-12-25T17:24:50+09:00
---

Go で形態素解析 API を作りたくて、Go で MeCab を NEologd で使う方法を調べました。
...
MeCab ではないけど Pure Go な形態素解析器もありました。
...
## インストール
MeCab、mecab-config、NEologd のインストールは省略します。
...
`mecab.New` の引数として MeCab のオプションを渡せばいいみたいです。
