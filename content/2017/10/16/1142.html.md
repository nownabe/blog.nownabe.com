...
date: 2017-10-02T13:58:35+09:00
lastmod: 2017-10-16T22:51:15+09:00
---
...
## 今回の内容
* 統計学と確率論の大きな違いの 1 つは、母数を推定するかしないか
...
### 11.1 点推定と区間推定
* **点推定 (point estimation)**: $\theta$をある 1 つの値$\hat{\theta}$で推定する方法
...
* **モーメント法 (method of moments)**
    * 標本モーメントを次のように定義する
        * 1 次標本モーメント $\hat{\mu}_1=\sum\frac{X_i}{n}$
        * 2 次標本モーメント $\hat{\mu}_2=\sum\frac{X_i^2}{n}$
        * k 次標本モーメント $\hat{\mu}_k=\sum\frac{X_i^k}{n}$
...
* 信頼区間の幅は標本の大きさ$n$が大きくなるに従って$\frac{1}{\sqrt{n}}$のオーダーで 0 に近づく
