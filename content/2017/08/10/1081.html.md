...
date: 2017-08-08T16:06:42+09:00
lastmod: 2017-08-10T13:59:51+09:00
---
...
* **確率分布 (probability distribution)**
    ...
    * $f(x_k) \geq 0, (k=1, 2, \dots) \text{かつ} \sum_k f(x_k) = 1$を満たす
    * **離散型の確率分布 (p. d. of discrete type)**
* **連続型 (continuous type)**
    * 連続値をとる確率変数
    * $P(a\geq X \geq b) = \int_a^bf(x)dx$で表される
    * ただし、$\text{すべての}x\text{に対し}f(x)\geq 0 \text{かつ} \int_{-\infty}^\infty f(x)dx=1$を満たす
